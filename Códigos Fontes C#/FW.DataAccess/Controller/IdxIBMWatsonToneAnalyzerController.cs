...
{
    public class IdxIBMWatsonToneAnalyzerController
    {
        public void Add(IdxIBMWatsonToneAnalyzer oIndexEmotionFeedPos)
        {
            try
            {
                using (Entities db = new Entities())
                {
                   db.Entry(oIndexEmotionFeedPos).State = System.Data.Entity.EntityState.Added;
                   db.SaveChanges();
                }
            }
